...
bool CartesianImpedanceController::init(hardware_interface::RobotHW *robot_hw, ros::NodeHandle &node_handle)
{
    ...
    sub_equilibrium_pose_ = node_handle.subscribe("equilibrium_pose", 20, &CartesianImpedanceController::equilibriumPoseCallback, this,
    ...
    {
        ROS_ERROR("CartesianImpedanceController: Invalid or no joint_names parameters provided, "
...
void CartesianImpedanceController::starting(const ros::Time & /*time*/)
{
    ...
    // std::cout << "Debug: position_d" << position_d_ << std::endl;

    orientation_d_     = Eigen::Quaterniond(initial_transform.linear());
    position_d_target_ = initial_transform.translation();
    // std::cout << "Debug: position_d_target_" << position_d_target_ << std::endl;
...
void CartesianImpedanceController::update(const ros::Time & /*time*/, const ros::Duration & /*period*/)
{
    ...
    // std::cout << "Debug: error.head(3)" << error.head(3) << std::endl;
...
void CartesianImpedanceController::complianceParamCallback(franka_example_controllers::compliance_paramConfig &config, uint32_t /*level*/)
{
...
PLUGINLIB_EXPORT_CLASS(pandaria_ros::CartesianImpedanceController, controller_interface::ControllerBase)
